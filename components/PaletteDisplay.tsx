...
const PaletteDisplay : React.FC<PaletteDisplayProps> = ({
    ...
    return (
        <div className="w-full flex flex-col items-center">
            <div className="bg-white border mb-4 p-4 rounded-lg md:max-w-[60%] border-gray-500">
                ...
                <div className="">
                    ...
                    <div className="flex flex-row flex-wrap gap-12">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-gray-700 mb-3">Accent</h4>
                            <div className="flex gap-2 flex-wrap">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-gray-700 mb-3">Surface</h4>
                            <div className="flex gap-2 flex-wrap">
